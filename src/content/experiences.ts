...
export const experiences: Record<string, ExperienceConfig> = {
  estate: {
    ...
    scenes: [
      { at: 0.04, align: "center", eyebrow: "Meridian Estates", title: "Welcome home.", body: "One address. Presented privately, to a chosen few." },
      { at: 0.18, align: "left", eyebrow: "Now arriving", title: "20 Bayshore Terrace", body: "Past the gates, the water opens — and so does the house." },
      { at: 0.33, align: "left", eyebrow: "The residence", title: "Made to be lived in.", stats: [{ v: "6", l: "Beds" }, { v: "8", l: "Baths" }, { v: "11,400", l: "Sq Ft" }, { v: "0.9", l: "Acres" }] },
      { at: 0.48, align: "right", eyebrow: "The life here", title: "Infinity pool. Private dock. 180° of open water.", body: "Glass walls slide away. Inside and outside become one." },
      { at: 0.62, align: "left", eyebrow: "Your agent", title: "Alexandra Reyes", body: "$1.2B+ sold. She guides you personally — first showing to closing." },
      { at: 0.76, align: "right", eyebrow: "The firm", title: "Meridian Estates", body: "Boutique by design, global by reach — the name great listings trust." },
      { at: 0.9, align: "center", eyebrow: "Offered at $24,500,000", title: "The full listing is just below.", cta: false },
    ],
    site: {
      ...
      listings: [
        { title: "20 Bayshore Terrace", price: "$24,500,000", meta: "6 BD · 8 BA · 11,400 SF", img: "/template-previews/_assets/hero-luxury-exterior.jpg" },
        { title: "The Glass House", price: "$18,900,000", meta: "5 BD · 6 BA · 8,900 SF", img: "/template-previews/_assets/hero-waterfront.jpg" },
        { title: "Cascade Estate", price: "$31,000,000", meta: "7 BD · 9 BA · 14,200 SF", img: "/template-previews/_assets/hero-estate.jpg" },
      ],
      ...
      agentImg: "/template-previews/_assets/agent-f1.jpg",
      ...
      neighborhoodImg: "/template-previews/_assets/city-skyline.jpg",
